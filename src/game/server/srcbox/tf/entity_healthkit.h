...
class CHealthKitTF : public CTFPowerup, public IHealthKitAutoList
{
public:
	DECLARE_CLASS( CHealthKitTF, CTFPowerup );
...
class CHealthKitSmall : public CHealthKitTF
{
public:
	DECLARE_CLASS( CHealthKitSmall, CHealthKitTF );
...
class CHealthKitMedium : public CHealthKitTF
{
public:
	DECLARE_CLASS( CHealthKitMedium, CHealthKitTF );
...
class CHealthAmmoKit : public CHealthKitTF
{
public:
	DECLARE_CLASS( CHealthAmmoKit, CHealthKitTF );
	powerupsize_t	GetPowerupSize( void ) { return POWERUP_SMALL; }
