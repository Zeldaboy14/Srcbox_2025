...
static ConVar cl_defaultweapon( "cl_defaultweapon", "weapon_physgun", FCVAR_USERINFO | FCVAR_ARCHIVE, "Default Spawn Weapon");
...
public:
	...
	virtual void PostDataUpdate(DataUpdateType_t updateType)
	{
		...
		{
			pPlayer->DoAnimationEvent((Activity)m_iEvent.Get(), m_nData);
		}
	}
...
void C_HL2MP_Player::DoAnimationEvent(Activity nActivity, int nData)
{
	if (IsLocalPlayer())
	{
