...
void CBaseModPanel::OnLevelLoadingStarted( char const *levelName, bool bShowProgressDialog )
{
	...
	*/
	...
	if ( bShowPoster )
	{
		...
		// Theres code in swarm that is used here. VS2013 doesn't like pAvatarNames being unitialized. Adding to fix...
		// TODO: Fix avatar names. why is it there if not used?????
