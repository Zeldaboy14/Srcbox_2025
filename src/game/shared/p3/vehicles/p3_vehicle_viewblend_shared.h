...
#ifndef P3_VEHICLE_VIEWBLEND_SHARED_H
#define P3_VEHICLE_VIEWBLEND_SHARED_H
#ifdef _WIN32
#pragma once
#endif

// Definition for how to calculate a point on the remap curve
enum P3_RemapAngleRange_CurvePart_t
{
	P3_RemapAngleRange_CurvePart_Zero = 0,
	P3_RemapAngleRange_CurvePart_Spline,
	P3_RemapAngleRange_CurvePart_Linear,
};
...
struct P3_ViewSmoothingData_t
{
	...
	P3_ViewLockData_t pitchLockData;
	P3_ViewLockData_t rollLockData;
...
#endif // P3_VEHICLE_VIEWBLEND_SHARED_H
