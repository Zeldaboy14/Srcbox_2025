...
#ifndef P3_SIMULATOR_VIEWBLEND_SHARED_H
#define P3_SIMULATOR_VIEWBLEND_SHARED_H
#ifdef _WIN32
#pragma once
#endif

// Definition for how to calculate a point on the remap curve
enum P3_SimulatorRemapAngleRange_CurvePart_t
{
	P3_SimulatorRemapAngleRange_CurvePart_Zero = 0,
	P3_SimulatorRemapAngleRange_CurvePart_Spline,
	P3_SimulatorRemapAngleRange_CurvePart_Linear,
};
...
struct P3_SimulatorViewLockData_t
{
...
struct P3_SimulatorViewSmoothingData_t
{
	DECLARE_SIMPLE_DATADESC();

	// Fill these out in your vehicle
	CBaseAnimating	*pVehicle, *pViewBody;
	...
	P3_SimulatorViewLockData_t pitchLockData;
	P3_SimulatorViewLockData_t rollLockData;
...
#endif // P3_SIMULATOR_VIEWBLEND_SHARED_H
