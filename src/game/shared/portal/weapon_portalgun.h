...
//-----------------------------------------------------------------------------
bool PlayerHasMegaPortalGun();

// force the PortalGun to drop an object (if carried)
...
bool PlayerPickupControllerIsHoldingEntityPortalGun( CBaseEntity *pPickupController, CBaseEntity *pHeldEntity );
...
struct portalgun_shadowcontrol_params_t : public hlshadowcontrol_params_t
{
	DECLARE_SIMPLE_DATADESC();
};


#define PortalGun_BEAM_SPRITE "sprites/orangelight1.vmt"
#define PortalGun_BEAM_SPRITE_NOZ "sprites/orangelight1_noz.vmt"
#define PortalGun_GLOW_SPRITE "sprites/glow04_noz"
#define PortalGun_ENDCAP_SPRITE "sprites/orangeflare1"
#define PortalGun_CENTER_GLOW "sprites/orangecore1"
#define PortalGun_BLAST_SPRITE "sprites/orangecore2"
...
{
public:
	CPortalGunEffect( void ) : m_vecColor( 255, 255, 255 ), m_bVisible( true ), m_nAttachment( -1 ) {};
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------
//  CPortalGunEffectBeam class
//----------------------------------------------------------------------------------------------------------------------------------------------------------

class CPortalGunEffectBeam
{
public:
	CPortalGunEffectBeam( void ) : m_pBeam( NULL ) {};
...
public:
	...
	~CGrabControllerPortalGun( void );
	void AttachEntity( CBasePlayer *pPlayer, CBaseEntity *pEntity, IPhysicsObject *pPhys, bool bIsMegaPortalGun, const Vector &vGrabPosition, bool bUseGrabPosition );
...
private:
	...
	portalgun_shadowcontrol_params_t	m_shadow;
...
extern class CGrabControllerPortalGun;
...
protected:
	...
	enum EffectType_t
	{
		...
		PortalGun_ENDCAP2,
		PortalGun_ENDCAP3,	// Only used in third-person!

		NUM_PortalGun_PARAMETERS	// Must be last!
	};

#define	NUM_GLOW_SPRITES ((CWeaponPortalGun::PortalGun_GLOW6-CWeaponPortalGun::PortalGun_GLOW1)+1)
#define NUM_ENDCAP_SPRITES ((CWeaponPortalGun::PortalGun_ENDCAP3-CWeaponPortalGun::PortalGun_ENDCAP1)+1)

#define	NUM_PortalGun_BEAMS	3
