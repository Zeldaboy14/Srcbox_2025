...
//#ifdef P3_DLL
	...
	// common
		...
		ACT_WALK_HOSTAGE,
		ACT_IDLE_HOSTAGE,
		ACT_HOSTAGE_IN_GESTURE_FRONT,
		ACT_HOSTAGE_IN_GESTURE_BACK,
		ACT_HOSTAGE_OUT_GESTURE,
		ACT_HOSTAGE_OUT,
		ACT_HOSTAGE_DEATH_OUT,
		ACT_HOSTAGE_FLINCH_GESTURE,
		ACT_HOSTAGE_GESTURE_RELOAD,
		ACT_HOSTAGE_ATTACK1,
		ACT_HOSTAGE_ATTACK2,

		ACT_GESTURE_RELOAD_LEFT,

		// укрывание за препятствиями
		ACT_COVER_BEGIN_LEFT_HIGH,
		ACT_COVER_BEGIN_LEFT_LOW,
		ACT_COVER_BEGIN_RIGHT_HIGH,
		ACT_COVER_BEGIN_RIGHT_LOW,
		ACT_COVER_BEGIN_FRONT_LOW,
		ACT_COVER_END_LEFT_HIGH,
		ACT_COVER_END_LEFT_LOW,
		ACT_COVER_END_RIGHT_HIGH,
		ACT_COVER_END_RIGHT_LOW,
		ACT_COVER_END_FRONT_LOW,
		ACT_COVER_BEGIN_BURST_LEFT_HIGH,
		ACT_COVER_BEGIN_BURST_LEFT_LOW,
		ACT_COVER_BEGIN_BURST_RIGHT_HIGH,
		ACT_COVER_BEGIN_BURST_RIGHT_LOW,
		ACT_COVER_BEGIN_BURST_FRONT_LOW,
		ACT_COVER_MOVE_LEFT_HIGH,
		ACT_COVER_MOVE_LEFT_LOW,
		ACT_COVER_MOVE_RIGHT_HIGH,
		ACT_COVER_MOVE_RIGHT_LOW,
		ACT_COVER_IDLE_LEFT_HIGH,
		ACT_COVER_IDLE_AIM_LEFT_HIGH,
		ACT_COVER_IDLE_LEFT_LOW,
		ACT_COVER_IDLE_RIGHT_HIGH,
		ACT_COVER_IDLE_AIM_RIGHT_HIGH,
		ACT_COVER_IDLE_RIGHT_LOW,
		ACT_COVER_IDLE_FRONT_LOW,
		ACT_COVER_IDLE_AIM_FRONT_LOW,
		ACT_COVER_IDLE_BACK_LEFT_HIGH,
		ACT_COVER_IDLE_BACK_RIGHT_HIGH,
		ACT_COVER_IDLE_BACK_LEFT_LOW,
		ACT_COVER_IDLE_BACK_RIGHT_LOW,
		ACT_COVER_LOOK_LEFT_HIGH,
		ACT_COVER_LOOK_LEFT_LOW,
		ACT_COVER_LOOK_RIGHT_HIGH,
		ACT_COVER_LOOK_RIGHT_LOW,
		ACT_COVER_LOOK_FRONT_LOW,
		ACT_COVER_AIM_LEFT_HIGH,
		ACT_COVER_AIM_LEFT_LOW,
		ACT_COVER_AIM_RIGHT_HIGH,
		ACT_COVER_AIM_RIGHT_LOW,
		ACT_COVER_AIM_FRONT_LEFT_LOW,
		ACT_COVER_AIM_FRONT_RIGHT_LOW,
		ACT_COVER_AIM_BACK_LEFT_HIGH,
		ACT_COVER_AIM_BACK_LEFT_LOW,
		ACT_COVER_AIM_BACK_RIGHT_HIGH,
		ACT_COVER_AIM_BACK_RIGHT_LOW,
		ACT_COVER_AIM_LEFT_HIGH_ZOOM,
		ACT_COVER_AIM_LEFT_LOW_ZOOM,
		ACT_COVER_AIM_RIGHT_HIGH_ZOOM,
		ACT_COVER_AIM_RIGHT_LOW_ZOOM,
		ACT_COVER_AIM_FRONT_LEFT_LOW_ZOOM,
		ACT_COVER_AIM_FRONT_RIGHT_LOW_ZOOM,
		ACT_COVER_AIM_BACK_LEFT_HIGH_ZOOM,
		ACT_COVER_AIM_BACK_LEFT_LOW_ZOOM,
		ACT_COVER_AIM_BACK_RIGHT_HIGH_ZOOM,
		ACT_COVER_AIM_BACK_RIGHT_LOW_ZOOM,
		ACT_COVER_ATTACK_LEFT,
		ACT_COVER_ATTACK_RIGHT,
		ACT_COVER_ATTACK_FORWARD,
		ACT_COVER_ATTACK_FRONT_LEFT,
		ACT_COVER_ATTACK_FRONT_RIGHT,
		ACT_COVER_ATTACK_BACK_LEFT,
		ACT_COVER_ATTACK_BACK_RIGHT,
		ACT_COVER_ATTACK_LEFT_ZOOM,
		ACT_COVER_ATTACK_RIGHT_ZOOM,
		ACT_COVER_ATTACK_FORWARD_ZOOM,
		ACT_COVER_ATTACK_FRONT_LEFT_ZOOM,
		ACT_COVER_ATTACK_FRONT_RIGHT_ZOOM,
		ACT_COVER_ATTACK_BACK_LEFT_ZOOM,
		ACT_COVER_ATTACK_BACK_RIGHT_ZOOM,
		ACT_COVER_RELOAD_LEFT_HIGH,
		ACT_COVER_RELOAD_LEFT_LOW,
		ACT_COVER_RELOAD_RIGHT_HIGH,
		ACT_COVER_RELOAD_RIGHT_LOW,
		ACT_COVER_RELOAD_FRONT_LOW,
		ACT_COVER_JUMP_RIGHT,
		ACT_COVER_JUMP_LEFT,

		// for wolverine weapon
		ACT_WOLVERINE_ATTACK_BEGIN,
		ACT_WOLVERINE_ATTACK_IDLE,
		ACT_WOLVERINE_ATTACK_END,
		ACT_WOLVERINE_ATTACK2_BEGIN,
		ACT_WOLVERINE_ATTACK2_IDLE,
		ACT_WOLVERINE_ATTACK2_END,
		ACT_WOLVERINE_IDLE,
		ACT_WOLVERINE_IDLE_SPECIAL,
		ACT_WOLVERINE_RUN,
		ACT_WOLVERINE_KILL,
		ACT_WOLVERINE_WALK,
		ACT_WOLVERINE_JUMP,
		ACT_WOLVERINE_BURST,
		ACT_WOLVERINE_COVER_MOVE_LEFT_HIGH,
		ACT_WOLVERINE_COVER_MOVE_RIGHT_HIGH,
		ACT_WOLVERINE_COVER_MOVE_LEFT_LOW,
		ACT_WOLVERINE_COVER_MOVE_RIGHT_LOW,
		ACT_WOLVERINE_COVER_IDLE_LEFT_HIGH,
		ACT_WOLVERINE_COVER_IDLE_RIGHT_HIGH,
		ACT_WOLVERINE_COVER_IDLE_LEFT_LOW,
		ACT_WOLVERINE_COVER_IDLE_RIGHT_LOW,
		ACT_WOLVERINE_COVER_IDLE_BACK_LEFT_HIGH,
		ACT_WOLVERINE_COVER_IDLE_BACK_RIGHT_HIGH,
		ACT_WOLVERINE_COVER_IDLE_BACK_LEFT_LOW,
		ACT_WOLVERINE_COVER_IDLE_BACK_RIGHT_LOW,
		ACT_WOLVERINE_COVER_LOOK_LEFT_HIGH,
		ACT_WOLVERINE_COVER_LOOK_RIGHT_HIGH,
		ACT_WOLVERINE_COVER_LOOK_LEFT_LOW,
		ACT_WOLVERINE_COVER_LOOK_RIGHT_LOW,

		//for deserteagle weapon
		ACT_DEAGLE_ATTACK,
		ACT_DEAGLE_ATTACK_LOW,
		ACT_DEAGLE_GESTURE_ATTACK,
		ACT_DEAGLE_IDLE,
		ACT_DEAGLE_IDLE_SPECIAL,
		ACT_DEAGLE_RUN,
		ACT_DEAGLE_IDLE_AIM,
		ACT_DEAGLE_RUN_AIM,
		ACT_DEAGLE_WALK_AIM,
		ACT_DEAGLE_WALK_CROUCH,
		ACT_DEAGLE_WALK_CROUCH_AIM,
		ACT_DEAGLE_RUN_CROUCH,
		ACT_DEAGLE_RUN_CROUCH_AIM,
		ACT_DEAGLE_RELOAD,
		ACT_DEAGLE_RELOAD_LEFT,
		ACT_DEAGLE_RELOAD_LOW,
		ACT_DEAGLE_GESTURE_RELOAD,
		ACT_DEAGLE_JUMP,
		ACT_DEAGLE_JUMP_AIM,
		ACT_DEAGLE_BURST,
		ACT_DEAGLE_COVER_BEGIN_LEFT_HIGH,
		ACT_DEAGLE_COVER_BEGIN_LEFT_LOW,
		ACT_DEAGLE_COVER_BEGIN_RIGHT_HIGH,
		ACT_DEAGLE_COVER_BEGIN_RIGHT_LOW,
		ACT_DEAGLE_COVER_BEGIN_FRONT_LOW,
		ACT_DEAGLE_COVER_END_LEFT_HIGH,
		ACT_DEAGLE_COVER_END_LEFT_LOW,
		ACT_DEAGLE_COVER_END_RIGHT_HIGH,
		ACT_DEAGLE_COVER_END_RIGHT_LOW,
		ACT_DEAGLE_COVER_END_FRONT_LOW,
		ACT_DEAGLE_COVER_MOVE_LEFT_HIGH,
		ACT_DEAGLE_COVER_MOVE_LEFT_LOW,
		ACT_DEAGLE_COVER_MOVE_RIGHT_HIGH,
		ACT_DEAGLE_COVER_MOVE_RIGHT_LOW,
		ACT_DEAGLE_COVER_IDLE_LEFT_HIGH,
		ACT_DEAGLE_COVER_IDLE_AIM_LEFT_HIGH,
		ACT_DEAGLE_COVER_IDLE_LEFT_LOW,
		ACT_DEAGLE_COVER_IDLE_RIGHT_HIGH,
		ACT_DEAGLE_COVER_IDLE_AIM_RIGHT_HIGH,
		ACT_DEAGLE_COVER_IDLE_RIGHT_LOW,
		ACT_DEAGLE_COVER_IDLE_FRONT_LOW,
		ACT_DEAGLE_COVER_IDLE_AIM_FRONT_LOW,
		ACT_DEAGLE_COVER_IDLE_BACK_LEFT_HIGH,
		ACT_DEAGLE_COVER_IDLE_BACK_RIGHT_HIGH,
		ACT_DEAGLE_COVER_IDLE_BACK_LEFT_LOW,
		ACT_DEAGLE_COVER_IDLE_BACK_RIGHT_LOW,
		ACT_DEAGLE_COVER_LOOK_LEFT_HIGH,
		ACT_DEAGLE_COVER_LOOK_LEFT_LOW,
		ACT_DEAGLE_COVER_LOOK_RIGHT_HIGH,
		ACT_DEAGLE_COVER_LOOK_RIGHT_LOW,
		ACT_DEAGLE_COVER_LOOK_FRONT_LOW,
		ACT_DEAGLE_COVER_RELOAD_LEFT_HIGH,
		ACT_DEAGLE_COVER_RELOAD_LEFT_LOW,
		ACT_DEAGLE_COVER_RELOAD_RIGHT_HIGH,
		ACT_DEAGLE_COVER_RELOAD_RIGHT_LOW,
		ACT_DEAGLE_COVER_RELOAD_FRONT_LOW,
		ACT_DEAGLE_COVER_AIM_LEFT_HIGH,
		ACT_DEAGLE_COVER_AIM_RIGHT_HIGH,
		ACT_DEAGLE_COVER_AIM_LEFT_LOW,
		ACT_DEAGLE_COVER_AIM_RIGHT_LOW,
		ACT_DEAGLE_COVER_AIM_RIGHT_HIGH_ZOOM,
		ACT_DEAGLE_COVER_AIM_RIGHT_LOW_ZOOM,
		ACT_DEAGLE_COVER_AIM_FRONT_LEFT_LOW_ZOOM,
		ACT_DEAGLE_COVER_AIM_FRONT_RIGHT_LOW_ZOOM,
		ACT_DEAGLE_COVER_AIM_BACK_LEFT_HIGH_ZOOM,
		ACT_DEAGLE_COVER_AIM_BACK_LEFT_LOW_ZOOM,
		ACT_DEAGLE_COVER_AIM_BACK_RIGHT_HIGH_ZOOM,
		ACT_DEAGLE_COVER_AIM_BACK_RIGHT_LOW_ZOOM,
		ACT_DEAGLE_COVER_AIM_FRONT_LEFT_LOW,
		ACT_DEAGLE_COVER_AIM_FRONT_RIGHT_LOW,
		ACT_DEAGLE_COVER_AIM_BACK_LEFT_HIGH,
		ACT_DEAGLE_COVER_AIM_BACK_RIGHT_HIGH,
		ACT_DEAGLE_COVER_AIM_BACK_LEFT_LOW,
		ACT_DEAGLE_COVER_AIM_BACK_RIGHT_LOW,
		ACT_DEAGLE_COVER_ATTACK_LEFT,
		ACT_DEAGLE_COVER_ATTACK_RIGHT,
		ACT_DEAGLE_COVER_ATTACK_FORWARD,
		ACT_DEAGLE_COVER_ATTACK_FRONT_LEFT,
		ACT_DEAGLE_COVER_ATTACK_FRONT_RIGHT,
		ACT_DEAGLE_COVER_ATTACK_BACK_LEFT,
		ACT_DEAGLE_COVER_ATTACK_BACK_RIGHT,
		ACT_DEAGLE_HOSTAGE_GESTURE_RELOAD,
		ACT_DEAGLE_SEGWAY_IDLE_FRONT_AIM,
		ACT_DEAGLE_SEGWAY_IDLE_RIGHT_AIM,
		ACT_DEAGLE_SEGWAY_IDLE_LEFT_AIM,
		ACT_DEAGLE_SEGWAY_MOVE_FRONT_AIM,
		ACT_DEAGLE_SEGWAY_MOVE_RIGHT_AIM,
		ACT_DEAGLE_SEGWAY_MOVE_LEFT_AIM,
		ACT_DEAGLE_SEGWAY_TILT_FRONT_AIM,
		ACT_DEAGLE_SEGWAY_TILT_RIGHT_AIM,
		ACT_DEAGLE_SEGWAY_TILT_LEFT_AIM,
		ACT_DEAGLE_SEGWAY_ATTACK_FRONT,
		ACT_DEAGLE_SEGWAY_ATTACK_RIGHT,
		ACT_DEAGLE_SEGWAY_ATTACK_LEFT,
		ACT_DEAGLE_HOSTAGE_ATTACK,
		ACT_DEAGLE_IDLE_ANGRY,
		ACT_DEAGLE_IDLE_ANGRY_LOW,
		ACT_DEAGLE_LOCKED_PUSH,

		//for laser pen weapon
		ACT_LASERPEN_ATTACK,
		ACT_LASERPEN_IDLE,
		ACT_LASERPEN_IDLE_SPECIAL,
		ACT_LASERPEN_RUN,
		ACT_LASERPEN_IDLE_AIM,
		ACT_LASERPEN_RUN_AIM,
		ACT_LASERPEN_WALK_AIM,
		ACT_LASERPEN_JUMP,
		ACT_LASERPEN_JUMP_AIM,
		ACT_LASERPEN_SECONDARY,
		...
		//UNIFIED LONG-BARRELED
		ACT_LB_UNI_ATTACK,
		ACT_LB_UNI_ATTACK_LOW,
		ACT_LB_UNI_GESTURE_ATTACK,
		ACT_LB_UNI_IDLE,
		ACT_LB_UNI_IDLE_SPECIAL,
		ACT_LB_UNI_IDLE_LOW,
		ACT_LB_UNI_RUN,
		ACT_LB_UNI_WALK,
		ACT_LB_UNI_IDLE_AIM,
		ACT_LB_UNI_RUN_AIM,
		ACT_LB_UNI_WALK_AIM,
		ACT_LB_UNI_WALK_CROUCH,
		ACT_LB_UNI_WALK_CROUCH_AIM,
		ACT_LB_UNI_RUN_CROUCH,
		ACT_LB_UNI_RUN_CROUCH_AIM,
		ACT_LB_UNI_IDLE_ZOOM_AIM,
		ACT_LB_UNI_WALK_ZOOM_AIM,
		ACT_LB_UNI_RUN_ZOOM_AIM,
		ACT_LB_UNI_RELOAD,
		ACT_LB_UNI_RELOAD_LOW,
		ACT_LB_UNI_GESTURE_RELOAD,
		ACT_LB_UNI_JUMP,
		ACT_LB_UNI_JUMP_AIM,
		ACT_LB_UNI_BURST,
		ACT_LB_UNI_COVER_BEGIN_LEFT_HIGH,
		ACT_LB_UNI_COVER_BEGIN_LEFT_LOW,
		ACT_LB_UNI_COVER_BEGIN_RIGHT_HIGH,
		ACT_LB_UNI_COVER_BEGIN_RIGHT_LOW,
		ACT_LB_UNI_COVER_BEGIN_FRONT_LOW,
		ACT_LB_UNI_COVER_END_LEFT_HIGH,
		ACT_LB_UNI_COVER_END_LEFT_LOW,
		ACT_LB_UNI_COVER_END_RIGHT_HIGH,
		ACT_LB_UNI_COVER_END_RIGHT_LOW,
		ACT_LB_UNI_COVER_END_FRONT_LOW,
		ACT_LB_UNI_COVER_MOVE_LEFT_HIGH,
		ACT_LB_UNI_COVER_MOVE_LEFT_LOW,
		ACT_LB_UNI_COVER_MOVE_RIGHT_HIGH,
		ACT_LB_UNI_COVER_MOVE_RIGHT_LOW,
		ACT_LB_UNI_COVER_IDLE_LEFT_HIGH,
		ACT_LB_UNI_COVER_IDLE_AIM_LEFT_HIGH,
		ACT_LB_UNI_COVER_IDLE_LEFT_LOW,
		ACT_LB_UNI_COVER_IDLE_RIGHT_HIGH,
		ACT_LB_UNI_COVER_IDLE_AIM_RIGHT_HIGH,
		ACT_LB_UNI_COVER_IDLE_RIGHT_LOW,
		ACT_LB_UNI_COVER_AIM_RIGHT_HIGH_ZOOM,
		ACT_LB_UNI_COVER_AIM_RIGHT_LOW_ZOOM,
		ACT_LB_UNI_COVER_AIM_FRONT_LEFT_LOW_ZOOM,
		ACT_LB_UNI_COVER_AIM_FRONT_RIGHT_LOW_ZOOM,
		ACT_LB_UNI_COVER_AIM_BACK_LEFT_HIGH_ZOOM,
		ACT_LB_UNI_COVER_AIM_BACK_LEFT_LOW_ZOOM,
		ACT_LB_UNI_COVER_AIM_BACK_RIGHT_HIGH_ZOOM,
		ACT_LB_UNI_COVER_AIM_BACK_RIGHT_LOW_ZOOM,
		ACT_LB_UNI_COVER_IDLE_FRONT_LOW,
		ACT_LB_UNI_COVER_IDLE_AIM_FRONT_LOW,
		ACT_LB_UNI_COVER_IDLE_BACK_LEFT_HIGH,
		ACT_LB_UNI_COVER_IDLE_BACK_RIGHT_HIGH,
		ACT_LB_UNI_COVER_IDLE_BACK_LEFT_LOW,
		ACT_LB_UNI_COVER_IDLE_BACK_RIGHT_LOW,
		ACT_LB_UNI_COVER_LOOK_LEFT_HIGH,
		ACT_LB_UNI_COVER_LOOK_LEFT_LOW,
		ACT_LB_UNI_COVER_LOOK_RIGHT_HIGH,
		ACT_LB_UNI_COVER_LOOK_RIGHT_LOW,
		ACT_LB_UNI_COVER_LOOK_FRONT_LOW,
		ACT_LB_UNI_COVER_RELOAD_LEFT_HIGH,
		ACT_LB_UNI_COVER_RELOAD_LEFT_LOW,
		ACT_LB_UNI_COVER_RELOAD_RIGHT_HIGH,
		ACT_LB_UNI_COVER_RELOAD_RIGHT_LOW,
		ACT_LB_UNI_COVER_RELOAD_FRONT_LOW,
		ACT_LB_UNI_COVER_AIM_LEFT_HIGH,
		ACT_LB_UNI_COVER_AIM_RIGHT_HIGH,
		ACT_LB_UNI_COVER_AIM_LEFT_LOW,
		ACT_LB_UNI_COVER_AIM_RIGHT_LOW,
		ACT_LB_UNI_COVER_AIM_FRONT_LEFT_LOW,
		ACT_LB_UNI_COVER_AIM_FRONT_RIGHT_LOW,
		ACT_LB_UNI_COVER_AIM_BACK_LEFT_HIGH,
		ACT_LB_UNI_COVER_AIM_BACK_RIGHT_HIGH,
		ACT_LB_UNI_COVER_AIM_BACK_LEFT_LOW,
		ACT_LB_UNI_COVER_AIM_BACK_RIGHT_LOW,
		ACT_LB_UNI_COVER_ATTACK_LEFT,
		ACT_LB_UNI_COVER_ATTACK_RIGHT,
		ACT_LB_UNI_COVER_ATTACK_FORWARD,
		ACT_LB_UNI_COVER_ATTACK_FRONT_LEFT,
		ACT_LB_UNI_COVER_ATTACK_FRONT_RIGHT,
		ACT_LB_UNI_COVER_ATTACK_BACK_LEFT,
		ACT_LB_UNI_COVER_ATTACK_BACK_RIGHT,
		ACT_LB_UNI_ATTACH_CAT,
		ACT_LB_UNI_IDLE_ANGRY,
		ACT_LB_UNI_IDLE_ANGRY_LOW,
		ACT_LB_UNI_LOCKED_PUSH,
		...
		ACT_M60_JUMP,
		ACT_M60_JUMP_AIM,
		ACT_M60_IDLE_ZOOM_AIM,
		ACT_M60_WALK_ZOOM_AIM,
		ACT_M60_BURST,
		ACT_M60_RUSH_ATTACK,
		ACT_M60_GESTURE_ATTACK,

		//for machete
		ACT_MACHETE_ATTACK1,
		ACT_MACHETE_ATTACK2,
		ACT_MACHETE_ATTACK1_INTERRUPT,
		ACT_MACHETE_ATTACK2_INTERRUPT,
		ACT_MACHETE_ATTACK_SLOW_INTERRUPT,
		ACT_MACHETE_IDLE,
		ACT_MACHETE_IDLE_SPECIAL,
		ACT_MACHETE_ATTACK_IDLE,
		ACT_MACHETE_RUN,
		ACT_MACHETE_WALK,
		ACT_MACHETE_JUMP,
		ACT_MACHETE_BURST,
		...
		ACT_SHOVEL_ATTACK1,
		ACT_SHOVEL_ATTACK2,
		ACT_SHOVEL_ATTACK1_PREPARE,
		ACT_SHOVEL_ATTACK2_PREPARE,
		ACT_SHOVEL_ATTACK1_INTERRUPT,
		ACT_SHOVEL_ATTACK2_INTERRUPT,
		ACT_SHOVEL_ATTACK_SLOW_INTERRUPT,
		ACT_SHOVEL_IDLE,
		ACT_SHOVEL_IDLE_SPECIAL,
		ACT_SHOVEL_ATTACK_IDLE,
		ACT_SHOVEL_RUN,
		ACT_SHOVEL_RUN_ATTACK1_PREPARE,
		ACT_SHOVEL_RUN_ATTACK2_PREPARE,
		ACT_SHOVEL_WALK,
		ACT_SHOVEL_JUMP,
		ACT_SHOVEL_BURST,
		ACT_SHOVEL_LOCKED_WEAPON_PUSH,

		//for sledgehammer
		ACT_SLEDGEHAMMER_ATTACK1,
		ACT_SLEDGEHAMMER_ATTACK2,
		ACT_SLEDGEHAMMER_ATTACK1_PREPARE,
		ACT_SLEDGEHAMMER_ATTACK2_PREPARE,
		ACT_SLEDGEHAMMER_ATTACK1_INTERRUPT,
		ACT_SLEDGEHAMMER_ATTACK2_INTERRUPT,
		ACT_SLEDGEHAMMER_ATTACK_SLOW_INTERRUPT,
		ACT_SLEDGEHAMMER_IDLE,
		ACT_SLEDGEHAMMER_IDLE_SPECIAL,
		ACT_SLEDGEHAMMER_ATTACK_IDLE,
		ACT_SLEDGEHAMMER_RUN,
		ACT_SLEDGEHAMMER_RUN_ATTACK1_PREPARE,
		ACT_SLEDGEHAMMER_RUN_ATTACK2_PREPARE,
		ACT_SLEDGEHAMMER_WALK,
		ACT_SLEDGEHAMMER_JUMP,
		ACT_SLEDGEHAMMER_BURST,

		//for nail bat
		ACT_NAILBAT_ATTACK1,
		ACT_NAILBAT_ATTACK2,
		ACT_NAILBAT_ATTACK1_INTERRUPT,
		ACT_NAILBAT_ATTACK2_INTERRUPT,
		ACT_NAILBAT_ATTACK_SLOW_INTERRUPT,
		ACT_NAILBAT_IDLE,
		ACT_NAILBAT_IDLE_SPECIAL,
		ACT_NAILBAT_ATTACK_IDLE,
		ACT_NAILBAT_RUN,
		ACT_NAILBAT_WALK,
		ACT_NAILBAT_JUMP,
		ACT_NAILBAT_BURST,
		ACT_NAILBAT_COVER_MOVE_LEFT_HIGH,
		ACT_NAILBAT_COVER_MOVE_RIGHT_HIGH,
		ACT_NAILBAT_COVER_MOVE_LEFT_LOW,
		ACT_NAILBAT_COVER_MOVE_RIGHT_LOW,
		ACT_NAILBAT_COVER_IDLE_LEFT_HIGH,
		ACT_NAILBAT_COVER_IDLE_RIGHT_HIGH,
		ACT_NAILBAT_COVER_IDLE_LEFT_LOW,
		ACT_NAILBAT_COVER_IDLE_RIGHT_LOW,
		ACT_NAILBAT_COVER_IDLE_BACK_LEFT_HIGH,
		ACT_NAILBAT_COVER_IDLE_BACK_RIGHT_HIGH,
		ACT_NAILBAT_COVER_IDLE_BACK_LEFT_LOW,
		ACT_NAILBAT_COVER_IDLE_BACK_RIGHT_LOW,
		ACT_NAILBAT_COVER_LOOK_LEFT_HIGH,
		ACT_NAILBAT_COVER_LOOK_RIGHT_HIGH,
		ACT_NAILBAT_COVER_LOOK_LEFT_LOW,
		ACT_NAILBAT_COVER_LOOK_RIGHT_LOW,

		ACT_WPN_NAILBAT_ROTATE,
		...
		ACT_M16_ATTACK_LOW,
		ACT_M16_IDLE_AIM,
		ACT_M16_IDLE_SPECIAL,
		ACT_M16_RUN_AIM,
		ACT_M16_WALK_AIM,
		ACT_M16_RELOAD,
		ACT_M16_RELOAD_LEFT,
		ACT_M16_RELOAD_WAIST,
		ACT_M16_COVER_RELOAD_LEFT_HIGH,
		ACT_M16_COVER_RELOAD_LEFT_LOW,
		ACT_M16_COVER_RELOAD_RIGHT_HIGH,
		ACT_M16_COVER_RELOAD_RIGHT_LOW,
		ACT_M16_COVER_RELOAD_FRONT_LOW,
		ACT_M16_JUMP,
		ACT_M16_JUMP_AIM,
		ACT_M16_IDLE_ZOOM_AIM,
		ACT_M16_WALK_ZOOM_AIM,
		ACT_M16_BURST,
		ACT_M16_ATTACH_CAT,
		ACT_M16_GESTURE_ATTACK,
		...
		ACT_M136_IDLE_ZOOM_AIM,
		ACT_M136_AIM_WALK,
		ACT_M136_RUN_AIM,
		ACT_M136_COVER_LOOK_LEFT_HIGH,
		ACT_M136_COVER_LOOK_RIGHT_HIGH,
		ACT_M136_COVER_LOOK_LEFT_LOW,
		ACT_M136_COVER_LOOK_RIGHT_LOW,
		ACT_M136_RELOAD,
		ACT_M136_RELOAD_LEFT,
		ACT_M136_COVER_IDLE_LEFT_HIGH,
		ACT_M136_COVER_IDLE_RIGHT_HIGH,
		ACT_M136_COVER_IDLE_BACK_LEFT_HIGH,
		ACT_M136_COVER_IDLE_BACK_RIGHT_HIGH,
		ACT_M136_COVER_IDLE_LEFT_LOW,
		ACT_M136_COVER_IDLE_RIGHT_LOW,
		ACT_M136_COVER_IDLE_BACK_LEFT_LOW,
		ACT_M136_COVER_IDLE_BACK_RIGHT_LOW,
		ACT_M136_COVER_MOVE_LEFT_HIGH,
		ACT_M136_COVER_MOVE_RIGHT_HIGH,
		ACT_M136_COVER_MOVE_LEFT_LOW,
		ACT_M136_COVER_MOVE_RIGHT_LOW,
		ACT_M136_COVER_AIM_LEFT_HIGH,
		ACT_M136_COVER_AIM_RIGHT_HIGH,
		ACT_M136_COVER_AIM_LEFT_LOW,
		ACT_M136_COVER_AIM_RIGHT_LOW,
		ACT_M136_COVER_AIM_FRONT_LEFT_LOW,
		ACT_M136_COVER_AIM_FRONT_RIGHT_LOW,
		ACT_M136_COVER_ATTACK_RIGHT,
		ACT_M136_USE_KICK,
		ACT_M136_USE_KICK_DOOR,
		ACT_M136_USE_KICK_FAIL,
		ACT_M136_CAT_RELOAD,
		ACT_M136_LOCKED_WEAPON_PUSH,


		//for P3_SHOTGUN
		ACT_P3_SHOTGUN_ATTACK,
		ACT_P3_SHOTGUN_ATTACK_LOW,
		ACT_P3_SHOTGUN_ATTACK_ZOOM,
		ACT_P3_SHOTGUN_IDLE_AIM,
		ACT_P3_SHOTGUN_IDLE_SPECIAL,
		ACT_P3_SHOTGUN_RUN_AIM,
		ACT_P3_SHOTGUN_WALK_AIM,
		ACT_P3_SHOTGUN_RELOAD,
		ACT_P3_SHOTGUN_RELOAD_LEFT,
		ACT_P3_SHOTGUN_JUMP,
		ACT_P3_SHOTGUN_JUMP_AIM,
		ACT_P3_SHOTGUN_IDLE_ZOOM_AIM,
		ACT_P3_SHOTGUN_WALK_ZOOM_AIM,
		ACT_P3_SHOTGUN_BURST,
		ACT_P3_SHOTGUN_GESTURE_ATTACK,
		ACT_P3_SHOTGUN_PUMP,
		ACT_P3_SHOTGUN_PUMP_AIM,
		ACT_P3_SHOTGUN_RELOAD_START,
		ACT_P3_SHOTGUN_RELOAD_FINISH,

		// for Gasoline
		ACT_GASOLINE_ATTACK_BEGIN,
		ACT_GASOLINE_ATTACK_IDLE,
		ACT_GASOLINE_ATTACK_END,
		ACT_GASOLINE_IDLE,
		ACT_GASOLINE_IDLE_SPECIAL,
		ACT_GASOLINE_RUN,
		ACT_GASOLINE_THROW_MATCH,
		ACT_GASOLINE_WALK,
		ACT_GASOLINE_JUMP,
		ACT_GASOLINE_BURST,
		ACT_GASOLINE_THROW,
		ACT_GASOLINE_COVER_MOVE_LEFT_HIGH,
		ACT_GASOLINE_COVER_MOVE_RIGHT_HIGH,
		ACT_GASOLINE_COVER_MOVE_LEFT_LOW,
		ACT_GASOLINE_COVER_MOVE_RIGHT_LOW,
		ACT_GASOLINE_COVER_IDLE_LEFT_HIGH,
		ACT_GASOLINE_COVER_IDLE_RIGHT_HIGH,
		ACT_GASOLINE_COVER_IDLE_LEFT_LOW,
		ACT_GASOLINE_COVER_IDLE_RIGHT_LOW,
		ACT_GASOLINE_COVER_IDLE_BACK_LEFT_HIGH,
		ACT_GASOLINE_COVER_IDLE_BACK_RIGHT_HIGH,
		ACT_GASOLINE_COVER_IDLE_BACK_LEFT_LOW,
		ACT_GASOLINE_COVER_IDLE_BACK_RIGHT_LOW,
		ACT_GASOLINE_COVER_LOOK_LEFT_HIGH,
		ACT_GASOLINE_COVER_LOOK_RIGHT_HIGH,
		ACT_GASOLINE_COVER_LOOK_LEFT_LOW,
		ACT_GASOLINE_COVER_LOOK_RIGHT_LOW,

		// for Spray
		ACT_SPRAY_ATTACK_BEGIN,
		ACT_SPRAY_ATTACK_IDLE,
		ACT_SPRAY_ATTACK_2_IDLE,
		ACT_SPRAY_ATTACK_END,
		ACT_SPRAY_ATTACK_2_BEGIN,
		ACT_SPRAY_ATTACK_2_END,
		ACT_SPRAY_IDLE,
		ACT_SPRAY_IDLE_SPECIAL,
		ACT_SPRAY_RUN,
		ACT_SPRAY_FIRE,
		ACT_SPRAY_WALK,
		ACT_SPRAY_JUMP,
		ACT_SPRAY_BURST,
		ACT_SPRAY_RELOAD,
		ACT_SPRAY_RELOAD_LEFT,
		ACT_SPRAY_IDLE_AIM,
		ACT_SPRAY_RUN_AIM,
		ACT_SPRAY_WALK_AIM,
		ACT_SPRAY_COVER_MOVE_LEFT_HIGH,
		ACT_SPRAY_COVER_MOVE_RIGHT_HIGH,
		ACT_SPRAY_COVER_MOVE_LEFT_LOW,
		ACT_SPRAY_COVER_MOVE_RIGHT_LOW,
		ACT_SPRAY_COVER_IDLE_LEFT_HIGH,
		ACT_SPRAY_COVER_IDLE_RIGHT_HIGH,
		ACT_SPRAY_COVER_IDLE_LEFT_LOW,
		ACT_SPRAY_COVER_IDLE_RIGHT_LOW,
		ACT_SPRAY_COVER_IDLE_BACK_LEFT_HIGH,
		ACT_SPRAY_COVER_IDLE_BACK_RIGHT_HIGH,
		ACT_SPRAY_COVER_IDLE_BACK_LEFT_LOW,
		ACT_SPRAY_COVER_IDLE_BACK_RIGHT_LOW,
		ACT_SPRAY_COVER_LOOK_LEFT_HIGH,
		ACT_SPRAY_COVER_LOOK_RIGHT_HIGH,
		ACT_SPRAY_COVER_LOOK_LEFT_LOW,
		ACT_SPRAY_COVER_LOOK_RIGHT_LOW,
		ACT_SPRAY_HOSTAGE_ATTACK1,
		...
		ACT_MOLOTOV_HOLSTER,
		ACT_MOLOTOV_IDLE,
		ACT_MOLOTOV_IDLE_SPECIAL,
		ACT_MOLOTOV_RUN,
		ACT_MOLOTOV_WALK,
		ACT_MOLOTOV_IDLE_AIM,
		ACT_MOLOTOV_RUN_AIM,
		ACT_MOLOTOV_WALK_AIM,
		ACT_MOLOTOV_BURST,
		ACT_MOLOTOV_THROW,
		ACT_MOLOTOV_THROW_LEFT,
		ACT_MOLOTOV_THROW_COVER_LEFT_HIGH,
		ACT_MOLOTOV_THROW_COVER_RIGHT_HIGH,
		ACT_MOLOTOV_THROW_COVER_LEFT_LOW,
		ACT_MOLOTOV_THROW_COVER_RIGHT_LOW,
		ACT_MOLOTOV_COVER_MOVE_LEFT_HIGH,
		ACT_MOLOTOV_COVER_MOVE_RIGHT_HIGH,
		ACT_MOLOTOV_COVER_MOVE_LEFT_LOW,
		ACT_MOLOTOV_COVER_MOVE_RIGHT_LOW,
		ACT_MOLOTOV_COVER_IDLE_LEFT_HIGH,
		ACT_MOLOTOV_COVER_IDLE_RIGHT_HIGH,
		ACT_MOLOTOV_COVER_IDLE_LEFT_LOW,
		ACT_MOLOTOV_COVER_IDLE_RIGHT_LOW,
		ACT_MOLOTOV_COVER_IDLE_BACK_LEFT_HIGH,
		ACT_MOLOTOV_COVER_IDLE_BACK_RIGHT_HIGH,
		ACT_MOLOTOV_COVER_IDLE_BACK_LEFT_LOW,
		ACT_MOLOTOV_COVER_IDLE_BACK_RIGHT_LOW,
		ACT_MOLOTOV_COVER_LOOK_LEFT_HIGH,
		ACT_MOLOTOV_COVER_LOOK_RIGHT_HIGH,
		ACT_MOLOTOV_COVER_LOOK_LEFT_LOW,
		ACT_MOLOTOV_COVER_LOOK_RIGHT_LOW,
		ACT_MOLOTOV_COVER_AIM_LEFT_HIGH,
		ACT_MOLOTOV_COVER_AIM_LEFT_LOW,
		ACT_MOLOTOV_COVER_AIM_RIGHT_HIGH,
		ACT_MOLOTOV_COVER_AIM_RIGHT_LOW,
		ACT_MOLOTOV_COVER_AIM_FRONT_LEFT_LOW,
		ACT_MOLOTOV_COVER_AIM_FRONT_RIGHT_LOW,
		ACT_MOLOTOV_COVER_AIM_BACK_LEFT_HIGH,
		ACT_MOLOTOV_COVER_AIM_BACK_LEFT_LOW,
		ACT_MOLOTOV_COVER_AIM_BACK_RIGHT_HIGH,
		ACT_MOLOTOV_COVER_AIM_BACK_RIGHT_LOW,
		ACT_GRENADE_CHECK,

		ACT_CAT_COVER_IDLE_LEFT_LOW,

		//Beehive 
		ACT_BEEHIVE_DRAW,
		ACT_BEEHIVE_HOLSTER,
		ACT_BEEHIVE_IDLE,
		ACT_BEEHIVE_PULLBACK_HIGH,
		ACT_BEEHIVE_PULLBACK_HIGH_IDLE,
		ACT_BEEHIVE_PULLBACK_LOW,
		ACT_BEEHIVE_THROW,
		ACT_BEEHIVE_PULLBACK_HIGH_COVER_LEFT,
		ACT_BEEHIVE_THROW_COVER_LEFT,
		ACT_BEEHIVE_PULLBACK_HIGH_COVER_RIGHT,
		ACT_BEEHIVE_THROW_COVER_RIGHT,
		ACT_BEEHIVE_PULLBACK_HIGH_COVER_LEFT_LOW,
		ACT_BEEHIVE_THROW_COVER_LEFT_LOW,
		ACT_BEEHIVE_PULLBACK_HIGH_COVER_RIGHT_LOW,
		ACT_BEEHIVE_THROW_COVER_RIGHT_LOW,
		ACT_BEEHIVE_PULLBACK_HIGH_COVER_LOW,
		ACT_BEEHIVE_THROW_COVER_LOW,
		ACT_BEEHIVE_IDLE_SPECIAL,
		ACT_BEEHIVE_RUN,
		ACT_BEEHIVE_WALK,
		ACT_BEEHIVE_JUMP,
		ACT_BEEHIVE_BURST,
		ACT_BEEHIVE_COVER_MOVE_LEFT_HIGH,
		ACT_BEEHIVE_COVER_MOVE_RIGHT_HIGH,
		ACT_BEEHIVE_COVER_MOVE_LEFT_LOW,
		ACT_BEEHIVE_COVER_MOVE_RIGHT_LOW,
		ACT_BEEHIVE_COVER_IDLE_LEFT_HIGH,
		ACT_BEEHIVE_COVER_IDLE_RIGHT_HIGH,
		ACT_BEEHIVE_COVER_IDLE_LEFT_LOW,
		ACT_BEEHIVE_COVER_IDLE_RIGHT_LOW,
		ACT_BEEHIVE_COVER_IDLE_BACK_LEFT_HIGH,
		ACT_BEEHIVE_COVER_IDLE_BACK_RIGHT_HIGH,
		ACT_BEEHIVE_COVER_IDLE_BACK_LEFT_LOW,
		ACT_BEEHIVE_COVER_IDLE_BACK_RIGHT_LOW,
		ACT_BEEHIVE_COVER_LOOK_LEFT_HIGH,
		ACT_BEEHIVE_COVER_LOOK_RIGHT_HIGH,
		ACT_BEEHIVE_COVER_LOOK_LEFT_LOW,
		ACT_BEEHIVE_COVER_LOOK_RIGHT_LOW,
		ACT_BEEHIVE_COVER_AIM_LEFT_HIGH,
		ACT_BEEHIVE_COVER_AIM_LEFT_LOW,
		ACT_BEEHIVE_COVER_AIM_RIGHT_HIGH,
		ACT_BEEHIVE_COVER_AIM_RIGHT_LOW,
		ACT_BEEHIVE_COVER_AIM_FRONT_LEFT_LOW,
		ACT_BEEHIVE_COVER_AIM_FRONT_RIGHT_LOW,
		ACT_BEEHIVE_COVER_AIM_BACK_LEFT_HIGH,
		ACT_BEEHIVE_COVER_AIM_BACK_LEFT_LOW,
		ACT_BEEHIVE_COVER_AIM_BACK_RIGHT_HIGH,
		ACT_BEEHIVE_COVER_AIM_BACK_RIGHT_LOW,
		...
		//for ShopVac
		ACT_SHOPVAC_ATTACK,
		ACT_SHOPVAC_IDLE_AIM,
		ACT_SHOPVAC_IDLE_SPECIAL,
		ACT_SHOPVAC_RUN_AIM,
		ACT_SHOPVAC_WALK_AIM,
		ACT_SHOPVAC_BURST,

		ACT_P3_GAMAMET_RELOAD,
		ACT_P3_GAMAMET_RELOAD_LEFT,
		ACT_P3_GAMAMET_RELOAD_START,
		ACT_P3_GAMAMET_RELOAD_FINISH,

		//for Grenade
		ACT_GRENADE_ATTACH_TO_CAT,
		...
		ACT_PHOTOCAM_AIM,
		ACT_PHOTOCAM_ATTACK,
		ACT_PHOTOCAM_GESTURE_ATTACK,

		// for TVCam
		ACT_TVCAM_AIM,
		ACT_TVCAM_ATTACK,
		ACT_TVCAM_GESTURE_ATTACK,

		// Postal3 weapon adding activity
		ACT_WPN_RUN,
		ACT_WPN_WALK,
		ACT_WPN_BURST,
		ACT_WPN_WALK_ZOOM,
		ACT_WPN_IDLE_ZOOM,
		ACT_WPN_ATTACK_IDLE,
		ACT_WPN_ATTACK_BEGIN,
		ACT_WPN_ATTACK_END,
		ACT_WPN_ATTACK2_IDLE,
		ACT_WPN_ATTACK2_BEGIN,
		ACT_WPN_ATTACK2_END,
		ACT_WPN_ATTACK_KILLING,
		...
		// Addition activity for npc
		ACT_REACTION_PISSING,
		ACT_REACTION_AFRAID,
		ACT_REACTION_STUN,

		// jump with aiming weapon
		ACT_JUMP_AIM,
		// open door activity
		ACT_OPENDOOR_PUSH,

		//Special back damage gestures
		ACT_GESTURE_SMALL_FLINCH_BACK,
		ACT_GESTURE_BIG_FLINCH_BACK,
		ACT_GESTURE_FLINCH_HEAD_BACK,
		ACT_GESTURE_FLINCH_CHEST_BACK,
		ACT_GESTURE_FLINCH_STOMACH_BACK,
		ACT_GESTURE_FLINCH_LEFTARM_BACK,
		ACT_GESTURE_FLINCH_RIGHTARM_BACK,
		ACT_GESTURE_FLINCH_LEFTLEG_BACK,
		ACT_GESTURE_FLINCH_RIGHTLEG_BACK,
		ACT_FLINCH_HEAD_BACK,
		ACT_FLINCH_CHEST_BACK,
		ACT_FLINCH_STOMACH_BACK,
		ACT_FLINCH_LEFTARM_BACK,
		ACT_FLINCH_RIGHTARM_BACK,
		ACT_FLINCH_LEFTLEG_BACK,
		ACT_FLINCH_RIGHTLEG_BACK,
		ACT_FLINCH_PHYSICS_BACK,
		ACT_FLINCH_FALL_FORWARD,
		ACT_FLINCH_FALL_BACK,
		ACT_STAND_UP_FORWARD,
		ACT_STAND_UP_BACK,
		ACT_BLOW_UP_BY_CLAWS,
		ACT_BLOW_UP_BY_CLAWS_BACK,
		ACT_FLINCH_HEAVY_HEAD,
		ACT_FLINCH_HEAVY_CHEST,
		ACT_FLINCH_HEAVY_STOMACH,
		ACT_FLINCH_HEAVY_LEFTARM,
		ACT_FLINCH_HEAVY_RIGHTARM,
		ACT_FLINCH_HEAVY_LEFTLEG,
		ACT_FLINCH_HEAVY_RIGHTLEG,
		ACT_FLINCH_HEAVY_HEAD_LEFT,
		ACT_FLINCH_HEAVY_CHEST_LEFT,
		ACT_FLINCH_HEAVY_STOMACH_LEFT,
		ACT_FLINCH_HEAVY_LEFTARM_LEFT,
		ACT_FLINCH_HEAVY_RIGHTARM_LEFT,
		ACT_FLINCH_HEAVY_LEFTLEG_LEFT,
		ACT_FLINCH_HEAVY_RIGHTLEG_LEFT,
		ACT_FLINCH_HEAVY_HEAD_RIGHT,
		ACT_FLINCH_HEAVY_CHEST_RIGHT,
		ACT_FLINCH_HEAVY_STOMACH_RIGHT,
		ACT_FLINCH_HEAVY_LEFTARM_RIGHT,
		ACT_FLINCH_HEAVY_RIGHTARM_RIGHT,
		ACT_FLINCH_HEAVY_LEFTLEG_RIGHT,
		ACT_FLINCH_HEAVY_RIGHTLEG_RIGHT,
		ACT_FLINCH_HEAVY_HEAD_BACK,
		ACT_FLINCH_HEAVY_CHEST_BACK,
		ACT_FLINCH_HEAVY_STOMACH_BACK,
		ACT_FLINCH_HEAVY_LEFTARM_BACK,
		ACT_FLINCH_HEAVY_RIGHTARM_BACK,
		ACT_FLINCH_HEAVY_LEFTLEG_BACK,
		ACT_FLINCH_HEAVY_RIGHTLEG_BACK,

		//for Segway	
		ACT_SEGWAY_IDLE,
		ACT_SEGWAY_TILT,
		ACT_SEGWAY_MOVE,
		ACT_SEGWAY_RANGE_ATTACK1,
		ACT_SEGWAY_CLOTH_WIND,

		//Die Without leg,hand etc
		ACT_DIE_NO_HEAD,
		ACT_DIE_NO_ARMR,
		ACT_DIE_NO_ARML,
		ACT_DIE_NO_LEGR,
		...
		// Cat
		ACT_ATTACH_CAT,
		ACT_DUDE_ATTACH_ITEM,
		ACT_DUDE_ATTACH_CAT_TO_M16,
		ACT_DUDE_ATTACH_GRENADE_TO_CAT,
		ACT_CAT_ATTACH_TO,
		ACT_CAT_ATTACH_TO_M16,
		ACT_CAT_ATTACH_GRENADE,
		ACT_IDLE_ON_BARRELL,
		ACT_CAT_ON_BARREL_M136,

		ACT_CAT_SUFFER_DUDE_R_HAND,
		ACT_CAT_SUFFER_DUDE_L_HAND,
		ACT_CAT_SUFFER_DUDE_R_LEG,
		ACT_CAT_SUFFER_DUDE_L_LEG,
		ACT_CAT_SNATCH_ATTACK_DUDE_R_HAND,
		ACT_CAT_SNATCH_ATTACK_DUDE_L_HAND,
		ACT_CAT_SNATCH_ATTACK_DUDE_R_LEG,
		ACT_CAT_SNATCH_ATTACK_DUDE_L_LEG,
		ACT_DUDE_TEAR_AWAY_R_HAND,
		ACT_DUDE_TEAR_AWAY_L_HAND,
		ACT_DUDE_TEAR_AWAY_R_LEG,
		ACT_DUDE_TEAR_AWAY_L_LEG,
		...
		ACT_MONKEY_FACEFUCK_DUDE,
		ACT_MONKEY_FACEFUCK_DUDE_THROW,
		...
		ACT_MONKEY_BURST,
		ACT_MONKEY_PICKUP,
		ACT_MTH_IDLE_SPECIAL,
		ACT_MTH_IDLE_SPECIAL_2,
		ACT_MTH_THROW,
		ACT_MTH_TAKE,
		ACT_MTH_DROP,
		ACT_MTH_HOLD,
		...
		ACT_RIDER_RHINO_IDLE,
		ACT_RIDER_RHINO_GALLOP,
		ACT_RIDER_RHINO_REBEL,
		...
		ACT_DOG_SNATCHED_L_HAND_ON_FLOOR,
		ACT_DOG_SNATCHED_L_HAND_ON_FOOTS,

		ACT_PICKUP,
		ACT_RELEASE_GRENADE,
		ACT_WEAPON_SWITCH,
		ACT_HOSTAGE_WEAPON_SWITCH,

		ACT_FIGHT_BLOCK_ENTER,
		ACT_FIGHT_BLOCK,
		ACT_FIGHT_BLOCK_OUT,
		ACT_FIGHT_BLOCK_STEP,
		ACT_FIGHT_BLOW_IDLE,
		ACT_FIGHT_BLOW_LEFT,
		ACT_FIGHT_BLOW_RIGHT,
		ACT_FIGHT_BLOW_LEFT_STEP,
		ACT_FIGHT_BLOW_RIGHT_STEP,

		// One-Handled weapon

		ACT_ONEHANDLED_PICKUP,
		...
		ACT_TAZER_ATTACK,
		ACT_TAZER_RELOAD,
		ACT_TAZER_RELOAD_LEFT,
		ACT_TAZER_GESTURE_RELOAD,
		ACT_TAZER_HOSTAGE_GESTURE_RELOAD,
		ACT_TAZER_CHARGE,
		ACT_TAZER_ATTACK2,
		ACT_TAZER_HOSTAGE_ATTACK,
		ACT_TAZER_HOSTAGE_ATTACK2,

		ACT_AGRESSION_PUSH,
		ACT_AGRESSION_PUSH_REACT,
