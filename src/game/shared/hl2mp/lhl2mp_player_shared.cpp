...
LUALIB_API lua_CExperiment_Player *luaL_optexperimentplayer( lua_State *L, int narg, CHL2MP_Player *def )
{
...
{
    CHL2MP_Player *player = LUA_BINDING_ARGUMENT( luaL_checkexperimentplayer, 1, "entity" );
...
//{
//    CHL2MP_Player *playerA = LUA_BINDING_ARGUMENT( luaL_toexperimentplayer, 1, "entity" );
//    CHL2MP_Player *playerB = LUA_BINDING_ARGUMENT( luaL_toexperimentplayer, 2, "other" );
//
...
//{
//    CHL2MP_Player *player = LUA_BINDING_ARGUMENT( luaL_toexperimentplayer, 1, "entity" );
//
//    if ( player == NULL )
//    {
...
//    else
//    {
//        lua_pushfstring( L, "CHL2MP_Player: %d \"%s\"", player->GetUserID(), player->GetPlayerName() );
//    }
//
//    return 1;
//}
...
//{
//    CHL2MP_Player::PushLuaInstanceSafe( L, ToExperimentPlayer( lua_toentity( L, 1 ) ) );
//    return 1;
//}
//
