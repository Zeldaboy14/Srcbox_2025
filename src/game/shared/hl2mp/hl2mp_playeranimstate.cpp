...
CHL2MPPlayerAnimState *CreateExperimentPlayerAnimState( CHL2MP_Player *pPlayer )
{
    ...
    movementData.m_flRunSpeed = pPlayer ? pPlayer->GetRunSpeed() : HL2_SPRINT_SPEED;
    movementData.m_flWalkSpeed = pPlayer ? pPlayer->GetWalkSpeed() : HL2_WALK_SPEED;
...
void CHL2MPPlayerAnimState::InitExperimentAnimState( CHL2MP_Player *pPlayer )
{
...
{
    CHL2MP_Player *pPlayer = GetExperimentPlayer();
...
void CHL2MPPlayerAnimState::Update( float eyeYaw, float eyePitch )
{
    ...
    CHL2MP_Player::PushLuaInstanceSafe( L, GetExperimentPlayer() );
