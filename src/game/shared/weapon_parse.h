...
// SHARED
	...
	char					szViewModelDual[MAX_WEAPON_STRING];		// View model of this weapon (dual)
	char					szWorldModel[MAX_WEAPON_STRING];		// Model of this weapon seen carried by the player
	char					szWorldModelDual[MAX_WEAPON_STRING];	// Model of this weapon seen carried by the player (dual)
	char					szGlobalModel[MAX_WEAPON_STRING];		// Model of this weapon seen in the world
	char					szAnimationPrefix[MAX_WEAPON_PREFIX];	// Prefix of the animations that should be used by the player carrying this weapon
	char					szCharacterViewmodelAddon[MAX_WEAPON_STRING];	// Prefix of the viewmodel that should be applied
	...
	// Terror specific
		// Viewmodel info
/*	CUtlMap<const char*, const char*> m_viewmodels;
	CUtlMap<const char*, const char*> m_dualViewmodels;
	CUtlMap<const char*, const char*> m_viewmodelAddons;
	char m_dualPlayerModel[64];
	char m_dualWorldModel[64];
	char m_addonAttachmentName[64];*/
