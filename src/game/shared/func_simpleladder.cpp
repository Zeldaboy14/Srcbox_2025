...
extern ConVar sv_showladders;
#endif

CUtlVector< CFuncSimpleLadder * >	CFuncSimpleLadder::s_Ladders;
...
int CFuncSimpleLadder::GetLadderCount()
{
	return s_Ladders.Count();
}

CFuncSimpleLadder *CFuncSimpleLadder::GetLadder( int index )
{
...
//-----------------------------------------------------------------------------
void CFuncSimpleLadder::Activate()
{
	// Chain to base class
	BaseClass::Activate();
...
// Purpose: 
//-----------------------------------------------------------------------------
void CFuncSimpleLadder::SearchForDismountPoints()
{
...
void CFuncSimpleLadder::SetEndPoints( const Vector& p1, const Vector& p2 )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CFuncSimpleLadder::DrawDebugGeometryOverlays()
{
#if !defined( CLIENT_DLL )
...
// Input  : org - 
//-----------------------------------------------------------------------------
void CFuncSimpleLadder::GetTopPosition( Vector& org )
{
...
// Input  : org - 
//-----------------------------------------------------------------------------
void CFuncSimpleLadder::GetBottomPosition( Vector& org )
{
...
//-----------------------------------------------------------------------------
void CFuncSimpleLadder::ComputeLadderDir( Vector& bottomToTopVec )
{
	Vector top;
	Vector bottom;
...
// Output : int
//-----------------------------------------------------------------------------
int CFuncSimpleLadder::GetDismountCount() const
{
...
//-----------------------------------------------------------------------------
CInfoLadderDismount *CFuncSimpleLadder::GetDismount( int index_ )
{
...
//			list - 
//-----------------------------------------------------------------------------
void CFuncSimpleLadder::FindNearbyDismountPoints( const Vector& origin, float radius, CUtlVector< CInfoLadderDismountHandle >& list )
{
#ifdef CLIENT_DLL
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CFuncSimpleLadder::InputEnable( inputdata_t &inputdata )
{
	m_bDisabled = false;
}
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CFuncSimpleLadder::InputDisable( inputdata_t &inputdata )
{
	m_bDisabled = true;
}
...
// Input  : *pPlayer - 
//-----------------------------------------------------------------------------
void CFuncSimpleLadder::PlayerGotOn( CBasePlayer *pPlayer )
{
#if !defined( CLIENT_DLL )
...
// Input  : *pPlayer - 
//-----------------------------------------------------------------------------
void CFuncSimpleLadder::PlayerGotOff( CBasePlayer *pPlayer )
{
#if !defined( CLIENT_DLL )
...
//-----------------------------------------------------------------------------
bool CFuncSimpleLadder::DontGetOnLadder( void ) const
{
	return m_bFakeLadder;
}

#if !defined(CLIENT_DLL)
const char *CFuncSimpleLadder::GetSurfacePropName()
{
...
IMPLEMENT_NETWORKCLASS_ALIASED( FuncSimpleLadder, DT_FuncSimpleLadder );

BEGIN_NETWORK_TABLE( CFuncSimpleLadder, DT_FuncSimpleLadder )
#if !defined( CLIENT_DLL )
...
LINK_ENTITY_TO_CLASS( func_simpleladder, CFuncSimpleLadder );

//---------------------------------------------------------
// Save/Restore
//---------------------------------------------------------
BEGIN_DATADESC( CFuncSimpleLadder )
...
#if defined( GAME_DLL )
int CFuncSimpleLadder::UpdateTransmitState()
{
