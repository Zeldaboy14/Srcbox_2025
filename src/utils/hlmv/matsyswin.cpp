...
MatSysWindow::draw ()
{
	...
	int verts = g_pStudioModel->GetDrawMetrics().Verts;
	int indexes = g_pStudioModel->GetDrawMetrics().Indexes;
	int triangles = g_pStudioModel->GetDrawMetrics().Tris;
	...
	g_ControlPanel->setPolycount( polycount, verts, indexes, triangles);
